  ...
  return (
    <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl p-4 md:p-6 lg:p-8 flex flex-col lg:flex-row gap-4 items-end border border-neutral-100">
      ...
      <div className="flex-1 w-full space-y-2">
        ...
        <Select
          value={city}
          onValueChange={(val) => setCity(val ?? 'nashik')}
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="indore" disabled>
              Indore (Soon)
            </SelectItem>
          </SelectContent>
        </Select>
      ...
      <div className="flex-1 w-full space-y-2">
        ...
        <Popover>
          <PopoverTrigger
            className={cn(
              "w-full h-12 justify-start text-left font-normal bg-neutral-50 border border-neutral-200 rounded-xl px-3",
      ...
      <div className="w-full lg:w-40 space-y-2">
        ...
        <Select
          value={duration}
          onValueChange={(val) => setDuration(val ?? '2')}
        >
